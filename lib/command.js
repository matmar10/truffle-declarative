...
class Command {
  ...
  constructor(definition) {
    ...
    assertValidateOptions(Command.schema, definition);

    if (-1 === Command.staticMethods.indexOf(definition.run)) {
      assertValidateOptions(Command.schemaInstanceMethod, definition);
      this.isStatic = false;
    } else {
      assertValidateOptions(Command.schemaStaticMethod, definition);
      this.isStatic = true;
    }
...
=======
    ...
    return false;
>>>>>>> 0142eb7ab32739da02a2e727aa3c597adc066fef
  }
